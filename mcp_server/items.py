...
ITEMS = [
    Item(
        ...
        price=29.99,
        image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSCTJxNM1ZuXKk4EGRpGh5FAP-4Rlf8rmcdA&s",
    ),
    Item(
        id=2,
    ...
    Item(
        ...
        description="Protect your applications from security threats",
        price=47.99,
        image_url="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRSCTJxNM1ZuXKk4EGRpGh5FAP-4Rlf8rmcdA&s",
    ),
]
